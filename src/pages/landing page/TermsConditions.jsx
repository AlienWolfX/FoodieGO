...
export const TermsConditions = () => {
 ...
 return (
  <>
   <div className="bg-mainbg h-full flex items-center justify-center">
    <div className="bg-white p-8 rounded-md w-[800px] mt-10 mb-10">
     <div className="flex items-center justify-center mb-20">
      <h1 className="text-4xl font-black text-gray-800">
       FoodieGO Terms and Condition
      </h1>
     </div>
     ...
     <div className="space-y-4 mt-5">
      ...
      <h2 className="text-lg font-semibold text-gray-600">Interpretation</h2>
      <div className="">
       <p>
       ...
       <div className="px-4">
        <ul className="list-disc mt-2 text-justify">
         ...
         <li>
          ...
          this Agreement) refers to FoodieGO, Ampayon, Butuan City, Philippines.
         </li>
         <li>
         ...
         <li>
          Website refers to FoodieGO, accessible from
          https://myfoodiego.vercel.app
         </li>
         <li>
     ...
     <div className="space-y-4 mt-5">
      ...
      <div>
       <h1 className="text-2xl font-bold text-gray-800">Law enforcement</h1>
       <p>
     ...
     <div className="space-y-4 mt-5">
      <h1 className="text-2xl font-bold text-gray-800">Children's Privacy</h1>
      <p>
     ...
     <div className="space-y-4 mt-5">
      ...
      <p>We may update Our Privacy Policy from time to tim</p>
      <p>
     ...
     <div className="space-y-4 mt-5">
      ...
      <p>
       ...
       By email: foodiego@help.com
      </p>
     </div>
     <div className="flex items-center justify-end mt-10">
      <button
       onClick={() => nav(-1)}
       className="h-10 bg-mainblue text-white font-medium rounded px-4"
      >
       Continue
      </button>
     </div>
