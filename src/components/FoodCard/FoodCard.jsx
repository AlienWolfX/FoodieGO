...
export const FoodCard = ({ recipes }) => {
 const CustomPrevArrow = (props) => {
  ...
  return (
   <div
    className={`${className} custom-arrow custom-prev-arrow flex items-center justify-center`}
 ...
 const CustomNextArrow = (props) => {
  ...
  return (
   <div
    className={`${className} custom-arrow custom-next-arrow flex items-center justify-center`}
    style={{ ...style, display: "block" }}
    onClick={onClick}
   />
  );
