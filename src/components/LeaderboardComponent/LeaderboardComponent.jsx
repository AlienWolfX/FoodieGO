 ...
 const popularFoodiegoers = [
  {
   ...
   role: "Chef",
   image:
    "https://api.dicebear.com/7.x/lorelei/svg?seed=ChefMeiLin&backgroundColor=b6e3f4",
   followers: 9800,
   recipes: 245,
   rank: 1,
   isFollowing: false,
  ...
  {
   id: 2,
   name: "Sompong Sudarat",
   role: "Chef",
   image:
    "https://api.dicebear.com/7.x/lorelei/svg?seed=SompongSudarat&backgroundColor=c0aede",
   followers: 9200,
   recipes: 188,
   rank: 2,
   isFollowing: false,
       ...
       >
        ...
        <div className="space-y-1.5">
         ...
         <div className="flex items-center gap-2">
          <span className="text-base font-bold text-gray-900">{stat.stat}</span>
          <span
           className={`
